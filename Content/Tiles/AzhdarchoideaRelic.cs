...
namespace BuriedHeavens.Content.Tiles {
	public class AzhdarchoideaRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "BuriedHeavens/Content/Tiles/AzhdarchoideaRelic";

		public override string Texture => "BuriedHeavens/Content/Tiles/RelicPedestal";
